...
public class UcusVerileriAnasayfa extends AppCompatActivity {


    Button _ucusverisial;
    ...
    public TextView secili_il;
    public TextView secili_ilce;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ucus_verileri_anasayfa);
        Toolbar toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);


        _ucusverisial = findViewById(R.id.haritalandirmagoster_button);
        ...
        selectDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                datePickerDialog = new DatePickerDialog(UcusVerileriAnasayfa.this, R.style.MyDialogTheme,
                        new DatePickerDialog.OnDateSetListener() {
                            ...
                            public void onDateSet(DatePicker datePicker, int year, int month, int day) {
                                ...
                                tarih=day_.concat(month_).concat(year_);
        ...
        spinner_iller =  findViewById(R.id.il_spinner);
        ...
        spinner_ilceler = findViewById(R.id.ilce_spinner);
        ...
        spinner_iller.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int i, long l) {
                ...
                if(parent.getSelectedItem().toString().equals(iller[0]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, adana_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[1]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, adiyaman_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[2]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, afyonkarahisar_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[3]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, agri_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[4]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, aksaray_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[5]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, amasya_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[6]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, ankara_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[7]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, antalya_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[8]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, ardahan_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[9]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, artvin_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[10]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, aydin_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[11]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, balikesir_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[12]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, bartin_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[13]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item,batman_ilce );
                else if(parent.getSelectedItem().toString().equals(iller[14]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, bayburt_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[15]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, bilecik_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[16]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, bingol_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[17]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, bitlis_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[18]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, bolu_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[19]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, burdur_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[20]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, bursa_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[21]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, canakkale_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[22]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, cankiri_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[23]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, corum_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[24]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, denizli_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[25]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, diyarbakir_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[26]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, duzce_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[27]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, edirne_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[28]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, elazig_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[29]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, erzincan_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[30]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, erzurum_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[31]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, eskisehir_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[32]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, gaziantep_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[33]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, giresun_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[34]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, gumushane_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[35]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, hakkari_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[36]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, hatay_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[37]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, igdir_ilce);
               else if(parent.getSelectedItem().toString().equals(iller[38]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, isparta_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[39]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, istanbul_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[40]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, izmir_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[41]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, kahramanmaras_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[42]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, karabuk_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[43]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, karaman_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[44]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, kars_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[45]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, kastomonu_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[46]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, kayseri_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[47]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, kilis_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[48]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item,kirikkale_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[49]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, kirklareli_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[50]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, kirsehir_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[51]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, kocaeli_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[52]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, konya_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[53]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, kutahya_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[54]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, malatya_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[55]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, manisa_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[56]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, mardin_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[57]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, mersin_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[58]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, mugla_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[59]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, mus_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[60]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, nevsehir_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[61]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, nigde_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[62]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, ordu_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[63]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, osmaniye_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[64]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, rize_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[65]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, sakarya_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[66]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, samsun_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[67]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, sanliurfa_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[68]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, siirt_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[69]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, sinop_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[70]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, sivas_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[71]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, sirnak_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[72]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, tekirdag_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[73]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, tokat_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[74]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, trabzon_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[75]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, tunceli_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[76]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, usak_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[77]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, van_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[78]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, yalova_ilce);
                else if(parent.getSelectedItem().toString().equals(iller[79]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, yozgat_ilce);
                else if (parent.getSelectedItem().toString().equals(iller[80]))
                    dataAdapter_ilceler = new ArrayAdapter<>(UcusVerileriAnasayfa.this, android.R.layout.simple_spinner_item, zonguldak_ilce);
                ...
                spinner_ilceler.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                    ...
                    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                        ...
                        ilce = adapterView.getItemAtPosition(i).toString();
                        secili_ilce = findViewById(R.id.ilcegoster_textView);
                        secili_ilce.setText(ilce);
        ...
        _ucusverisial.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View view) {
                Intent ucusVeri_sayfasi = new Intent(getApplicationContext(), UcusVerileri.class);
